                ...
                {liked === true ?
                    <>
                        <div className="" onClick={handleLike}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#7CC529" class="bi bi-heart-fill" viewBox="0 0 16 16">
                    ...
                    <>
                        <div className="" onClick={handleLike}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#7CC529" class="bi bi-heart" viewBox="0 0 16 16">
